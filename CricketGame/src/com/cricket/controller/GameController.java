    ...
    public void playGame(){
        try (Scanner scanner=new Scanner(System.in)) {
            ...
            if (targetScore > secondScore){
                System.out.println("Team "+ teamWonToss.getName() +" has won the match by "+ (targetScore-secondScore)+ " run");
            }else if (targetScore < secondScore){
                System.out.println("Team "+ teamLostToss.getName() +" has won the match by "+ (secondScore-targetScore)+ " run");
            }else {
            ...
            System.out.println("Game finished due to an error...");
        }
    }
